...
/***/ (function(module, exports, __webpack_require__) {
	...
	var productEvents = __webpack_require__(7);
	var orderEvents = __webpack_require__(34);
	var appEvents = __webpack_require__(39);
	var authEvents = __webpack_require__(40);
	var stripeEvents = __webpack_require__(45);

	var orderUi = __webpack_require__(37);
...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://protected-cliffs-21162.herokuapp.com'
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var productApi = __webpack_require__(8);
	var productUi = __webpack_require__(10);

	var onGetAllProducts = function onGetAllProducts() {
	  console.log('(products/events.js) onGetAllProducts ran!');

	  productApi.indexProducts().then(productUi.getAllProductsSuccess).catch(productUi.getAllProductsFailure);
	};
	...
	var onGetOneProduct = function onGetOneProduct(data) {
	  console.log('(products/events.js) onGetOneProduct ran!');
	  var productId = $(this).data('id');
	  console.log('productId is:', productId);
	  productApi.showProduct(productId).then(productUi.getOneProductSuccess).catch(productUi.getOneProductFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// see console logs.
	var buildOrder = __webpack_require__(12);

	var getAllProductsSuccess = function getAllProductsSuccess(ajaxResponse) {
	  console.log('(products/ui.js) getAllProductsSuccess ran!  Data is :', ajaxResponse);

	  var products = ajaxResponse;
	  store.products = products;
	  console.log(products);

	  $('#products').html('');
	  var displayAllProducts = __webpack_require__(13);
	  $('#products').prepend(displayAllProducts(products));
	};

	var getAllProductsFailure = function getAllProductsFailure(error) {
	  console.log('(products/ui.js) getAllProductsSuccess  Error is :', error);
	  console.error(error);
	};

	var getOneProductSuccess = function getOneProductSuccess(ajaxResponse) {
	  ...
	  var products = store.cart;
	  console.log(products);

	  $('#cartHandlebar').html('');
	  var displayAllProducts = __webpack_require__(33);
	...
	var getOneProductFailure = function getOneProductFailure(error) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var removeFromCart = function removeFromCart() {
	  ...
	  $('.remove-from-cart').on('click', function (event) {
	    ...
	    var index = $('.cartProductWrapper').index($(event.target).parent());
	    console.log(index);
	    store.cart.products.splice(index, 1);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var order = function order() {
	  ...
	  for (var i = 0; i < store.cart.products.length; i++) {
	    var name = store.cart.products[i].name;
	    var price = store.cart.products[i].price;
	    var qty = store.cart.products[i].quanitity;
	    var item = {};
	    item.name = name;
	    item.price = price;
	    item.qty = qty;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"productWrapper\" data-id=\""
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"cartProductWrapper\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n\n      <img src="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.image : stack1), depth0))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var orderApi = __webpack_require__(36);
	var orderUi = __webpack_require__(37);
	var store = __webpack_require__(9);
	...
	var onCreateOrder = function onCreateOrder() {
	  ...
	  orderApi.createOrder().then(orderUi.createOrderSuccess).catch(orderUi.createOrderFailure);
	};

	var onIndexOrders = function onIndexOrders(event) {
	  event.preventDefault();
	  ...
	  orderApi.indexOrders().then(orderUi.indexOrdersSuccess).catch(orderUi.indexOrdersFailure);
	};

	var onUpdateOrderRating = function onUpdateOrderRating(event) {
	  event.preventDefault();
	  ...
	  orderApi.updateOrder(orderId, rating).then(orderUi.updateOrderRatingSuccess).catch(orderUi.updateOrderRatingFailure);
	};
	...
	var onDeleteOrder = function onDeleteOrder(event) {
	  ...
	  var orderId = $(this).data('id');
	  orderApi.deleteOrder(orderId).then(orderUi.deleteOrderSuccess(orderId)).catch(orderUi.deleteOrderFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var errorTextNoCurrentOrders = 'You have no current orders.  Please submit an order!';
	...
	var createOrderFailure = function createOrderFailure(error) {
	  console.log('(orders/ui.js) createOrderFailure  Error is :', error);
	  console.error(error);
	};

	var indexOrdersSuccess = function indexOrdersSuccess(ajaxResponse) {
	  console.log('(orders/ui.js) indexOrdersSuccess ran!  Data is :', ajaxResponse);

	  var orders = ajaxResponse;
	  store.orders = orders;
	  ...
	  if (orders.orders.length === 0) {
	    ...
	    var displayAllOrders = __webpack_require__(38);
	    $('#display-orders').prepend(displayAllOrders(orders));
	  }
	};

	var indexOrdersFailure = function indexOrdersFailure(error) {
	  console.log('(orders/ui.js) indexOrdersFailure  Error is :', error);
	  console.error(error);
	};

	var updateOrderRatingSuccess = function updateOrderRatingSuccess(ajaxResponse) {
	  console.log('(orders/ui.js) updateOrderRatingSuccess ran!  Data is :', ajaxResponse);

	  // Show updated order rating to user
	  orderApi.indexOrders().then(indexOrdersSuccess).catch(indexOrdersFailure);
	};

	var updateOrderRatingFailure = function updateOrderRatingFailure(error) {
	  console.log('(orders/ui.js) updateOrderRatingFailure  Error is :', error);
	  console.error(error);
	};

	var deleteOrderSuccess = function deleteOrderSuccess(id) {
	  event.preventDefault();
	...
	var deleteOrderFailure = function deleteOrderFailure(error) {
	  console.log('(orders/ui.js) deleteOrderFailure  Error is :', error);
	  console.error(error);
	};

	var showViewOrderHistoryBtn = function showViewOrderHistoryBtn() {
	...
	var hideViewOrderHistoryBtn = function hideViewOrderHistoryBtn() {
	...
	module.exports = {
	  ...
	  indexOrdersFailure: indexOrdersFailure,
	  updateOrderRatingSuccess: updateOrderRatingSuccess,
	  updateOrderRatingFailure: updateOrderRatingFailure,
	  deleteOrderSuccess: deleteOrderSuccess,
	  deleteOrderFailure: deleteOrderFailure,
	  showViewOrderHistoryBtn: showViewOrderHistoryBtn,
	  hideViewOrderHistoryBtn: hideViewOrderHistoryBtn
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"orderWrapper\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n    <div class=\"orderDate\">\n      Order Date: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.orderDate : stack1), depth0))
	    + "\n    </div>\n    <div class=\"orderTotalPrice\">\n      Total: $"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.total : stack1), depth0))
	    + "\n    </div>\n    <div class=\"orderRating\">\n      Order Rating: "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.rating : stack1), depth0))
	    + "\n    </div>\n    <div class=\"setRating\">\n      <select class=\"ratingClass\" id=\"rating"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <option value=\"1\">1</option>\n        <option value=\"2\">2</option>\n        <option value=\"3\">3</option>\n        <option value=\"4\">4</option>\n        <option value=\"5\">5</option>\n      </select>\n      <button class=\"setOrderRatingBtn btn btn-primary btn-xs\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Update Rating</button>\n    </div>\n    <div class=\"remoteBtn\">\n      <button class=\"removeFromOrderHistoryBtn glyphicon glyphicon-trash\" id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"></button>\n    </div><br>\n  </div>\n\n";
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var uploadOrder = function uploadOrder(event) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var signInSuccess = function signInSuccess(ajaxResponse) {
	  ...
	  $('#products').html('');
	  var displayAllProducts = __webpack_require__(44);
	  $('#products').prepend(displayAllProducts(products));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <div class=\"productWrapper\" data-id=\""
	    ...
	    + "\n    </div>\n    <div class=\"productPrice\">\n      Price: $"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.price : stack1), depth0))
	    + "\n    </div>\n    <div class=\"addBtn\">\n      <button class=\"addToCartBtn btn btn-primary\" id=\"addProductBtn\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">Add to cart</button>\n    </div>\n  </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var orderEvents = __webpack_require__(34);
	var chargeApi = __webpack_require__(46);
	var store = __webpack_require__(9);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var stripeCharge = function stripeCharge(data) {
	  // const id = data.id
